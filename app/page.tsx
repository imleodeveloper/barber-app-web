    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-12 mb-8 rounded-lg">
        <div className="text-center">
          ...
          <p className="text-xl mb-6 opacity-90">
            Escolha o serviço desejado e reserve seu horário de forma rápida e fácil
          </p>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Nossos Serviços</h2>
          <p className="text-gray-600 dark:text-gray-400">Escolha o serviço desejado e agende seu horário</p>
        </div>

        <div className="grid gap-4 md:gap-6">
          {services.map((service) => (
            <Card key={service.id} className="bg-white dark:bg-gray-800 hover:shadow-lg transition-shadow">
